...
export function assertPositionOr(value: number | undefined): asserts value is PositionOrGenerative {
 ...
 */
export const computeBoardFromHistory = (history: MoveHistory, index?: number): Board => {
